...
ACTIVATION = {'sgn': sgn, 'sign': sign, 'logistic': logistic, 'rbf_gauss': rbf_gauss, 'rbf_green': rbf_green, 'x': x}
FIRST_DERIVATIVES = {'sgn': dsgn, 'sign': dsign, 'logistic': dlogistic, 'rbf_gauss': drbf_gauss, 'rbf_green': drbf_green}